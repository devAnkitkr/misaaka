...
export default function FeatureBanner() {
  return (
    <div className="flex flex-col md:flex-row justify-between items-center my-10 p-4 md:p-0">
      <div className="border rounded-lg w-full h-[150px] mx-4 my-4 flex justify-center items-center bg-white drop-shadow">
